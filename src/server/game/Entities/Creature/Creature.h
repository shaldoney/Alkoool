...
{
    INHABIT_GROUND = 1, INHABIT_WATER = 2, INHABIT_AIR = 4, INHABIT_ANYWHERE = INHABIT_GROUND | INHABIT_WATER | INHABIT_AIR
};
...
{
    TrainerSpell () :
            spell(0), spellCost(0), reqSkill(0), reqSkillValue(0), reqLevel(0), KillCredit(0)
    {
