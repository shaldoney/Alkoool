    ...
    {  // Right Side
        ...
        */
        ...
        public:
            ...
            struct boss_magmawAI : public BossAI
            {
                ...
                void EnterCombat(Unit* /*who*/)
                {
                    ...
                    events.ScheduleEvent(EVENT_VISUAL_PILLAR, 60000);
					...
					events.ScheduleEvent(EVENT_IGNITION, 120000);
                ...
                void UpdateAI(const uint32 diff)
                {
                    ...
                    while (uint32 eventId = events.ExecuteEvent())
                    {
                        ...
                        case EVENT_IN_RANGE_CHECK:
							if (Player* target = me->FindNearestPlayer(50.f, false))
                            if (target->GetDistance(me) > 20.f)
                        ...
                        case EVENT_MANGLE:
                            ...
                            break;
						case EVENT_VISUAL_PILLAR:
							if(Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, 500, true))
							me->SummonCreature(NPC_PILLAR_VISUAL,target->GetPositionX(),target->GetPositionY(),target->GetPositionZ(), 0,TEMPSUMMON_CORPSE_DESPAWN);
                            events.ScheduleEvent(EVENT_VISUAL_PILLAR, 60000);
							break;
                        case EVENT_MASSIVE_CRASH:
							...
							//events.CancelEvent(EVENT_VISUAL_PILLAR);
        ...
        public:
            ...
            {
                mob_pillar_of_flame_triggerAI(Creature* creature) : ScriptedAI(creature) 
				{
					creature->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_DISABLE_MOVE);
				}
        ...
        public:
            ...
            CreatureAI* GetAI(Creature* creature) const
            {
                return new mob_pillar_visualAI (creature);
            }

            struct mob_pillar_visualAI : public ScriptedAI
            {
                mob_pillar_visualAI(Creature* creature) : ScriptedAI(creature),Intialized(false)
				{
                ...
                void IsSummonedBy(Unit* summoner)
                {
                    me->SetReactState(REACT_PASSIVE);
                    me->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_DISABLE_MOVE | UNIT_FLAG_NOT_SELECTABLE);
					me->AddAura(SPELL_PILLAR_VISUAL, me);
                    //DoCastAOE(SPELL_PILLAR_OF_FLAME,true); // This is only for DBM warnings etc...
                    //me->SummonCreature(NPC_PILLAR_OF_FLAME_TRIGGER,me->GetPositionX(),me->GetPositionY(),me->GetPositionZ(), 0,TEMPSUMMON_CORPSE_DESPAWN);
                ...
                void UpdateAI(const uint32 diff)
                {
                    ...
                    {
						me->SummonCreature(NPC_PILLAR_OF_FLAME_TRIGGER,me->GetPositionX(),me->GetPositionY(),me->GetPositionZ(), 0,TEMPSUMMON_CORPSE_DESPAWN);
						if(Creature* Pillar = ObjectAccessor::GetCreature(*me,instance->GetData64(NPC_PILLAR_VISUAL)))
						Pillar->DespawnOrUnsummon();
						me->DespawnOrUnsummon();
